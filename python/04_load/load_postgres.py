...
try:
    ...
    if os.path.exists(sellers_path):
        ...
        print("\n  Sellers file not found - skipping")
...
print("  Detecting delayed orders...")
orders['is_delayed'] = (
...
if not sellers.empty and 'seller_id' in sellers.columns:
    ...
    print("    Sellers data not available - skipping")
